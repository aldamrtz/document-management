                    ...
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p class="section-description">
                                {{ __('documents.document_information_description') }}
                            </p>
                        </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full">
                            ...
                            <textarea
                                id="description"
                                name="description"
                                placeholder="{{ __('documents.description_placeholder') }}">{{ old('description') }}</textarea>
                ...
                <section class="form-section">
                    ...
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p class="section-description">
                                {{ __('documents.document_file_description') }}
                            </p>
                        </div>
                    ...
                    <div class="upload-area">
                        ...
                        <p class="upload-title">
                            {{ __('documents.select_pdf') }}
                        </p>

                        <p class="upload-description">
                            {{ __('documents.select_pdf_description') }}
                        </p>
                        ...
                        <p class="file-name" id="file-name">
                            {{ __('documents.no_file_selected') }}
                        </p>

                    </div>

                    <p class="field-hint">
                        {{ __('documents.allowed_format_pdf') }}
                    </p>
    ...
    <script>
        ...
        fileInput.addEventListener('change', function() {
            if (this.files.length > 0) {
                ...
                fileName.textContent = "{{ __('documents.no_file_selected') }}";
